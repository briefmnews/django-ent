...
class ENTInstitutionAdmin(admin.ModelAdmin):
    change_list_template = "django_ent/admin/change_list.html"
...
admin.site.register(ENTInstitution, ENTInstitutionAdmin)
