...
class BatchAddInstitutionForm(forms.Form):
    ...
    def clean_institutions_data(self):
        ...
        for institution_detail in institutions_data:
            ...
            ent_choices = [
                val[0] for val in ENTInstitution.ENVIRONNEMENTS_NUMERIQUES_DE_TRAVAIL
            ]
...
class BatchAddInstitutionsFormPreview(FormPreview):
    preview_template = "django_ent/admin/preview.html"
    form_template = "django_ent/admin/form.html"
    ...
    def done(self, request, cleaned_data):
        ...
        return redirect(reverse("admin:django_ent_institution_changelist"))
